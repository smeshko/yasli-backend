"""Vendored copy of the v1 snapshot contract.
...
1. Update `yasli/scraper/src/yasli_scraper/models.py` and regenerate
   `yasli/scraper/schemas/snapshot.v1.schema.json`.
2. Mirror the model changes in `yasli/backend/src/yasli/snapshot_contract/models.py`.
3. Replace `yasli/backend/tests/snapshot_contract/fixtures/snapshot.v1.schema.json`
